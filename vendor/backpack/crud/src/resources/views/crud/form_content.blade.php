...
@section('after_styles')
    ...
    <link rel="stylesheet" href="{{ asset('public/packages/backpack/crud/css/'.$action.'.css').'?v='.config('backpack.base.cachebusting_string') }}">
...
@section('after_scripts')
    ...
    <script src="{{ asset('public/packages/backpack/crud/js/'.$action.'.js').'?v='.config('backpack.base.cachebusting_string') }}"></script>
